...
// The push-notification functions (onEventChange/onTodoChange) are Firestore
// triggers the app never calls directly, so their region doesn't matter here.
// parseEventText IS called directly though, and deployed to us-central1 (the
// default for callable functions) rather than europe-west1 — this must match
// exactly or calls fail with "not-found".
